...
3. If you have an image in PNG, JPG, or JPEG format that you want to use as a favicon, simply rename it to `favicon.ico`. <br>For example, if your image is named `mylogo.jpg`, change its name and extension to `favicon.ico`. <br>
